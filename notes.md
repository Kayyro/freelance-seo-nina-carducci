...
- [x] Mise en place des balises **OpenGraph** (pour le partage Facebook/LinkedIn).
- [x] Configuration des **Twitter Cards**.
- [x] Implémentation des données structurées **Schema.org** (SEO local).
...
- [x] Correction des contrastes de couleurs (normes WCAG).

## 📊 Scores Lighthouse
| Axe | Départ | Actuel | Objectif |
|-----|--------|--------|----------|
| Performance | 74 | 95 | ≥ 90 ✅ |
| Accessibilité | 67 | 100 | ≥ 90 ✅ |
